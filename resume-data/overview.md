...
overviews:
  all:
    title: "Product Manager, Game Designer, Maker"
    paragraphs:
      - "I focus on web and mobile development, interactive media, and innovative technologies to build experiences that impact users. Over {years} years in agile settings have shaped my approach: emphasizing teamwork, embracing iteration, fostering clear communication, and prioritizing the user's needs above all. I'm convinced that passion shines through in the products we create and that great products come from the collective dedication and collaboration of closely connected teams."
  product-management:
